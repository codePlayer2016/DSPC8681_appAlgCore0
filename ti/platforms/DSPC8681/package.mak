...
override PKGDIR = ti/platforms/DSPC8681
...
package/%.xdc.inc package/%_ti.platforms.DSPC8681.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.platforms.DSPC8681" (because $@ is older than $(firstword $?))" ...
...
package/rel/undefinedti/platforms/DSPC8681package/package.rel.xml: package/package.cfg.xdc.inc
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	@$(MSG) generating schema include file list ...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.platforms.DSPC8681 $@
...
.PHONY: release,ti_platforms_DSPC8681
ti_platforms_DSPC8681.zip: package/package.bld.xml
ti_platforms_DSPC8681.zip: package/build.cfg
ti_platforms_DSPC8681.zip: package/package.xdc.inc
ti_platforms_DSPC8681.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_platforms_DSPC8681.zip.dep
endif
package/rel/ti_platforms_DSPC8681/ti/platforms/DSPC8681/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

ti_platforms_DSPC8681.zip: package/rel/ti_platforms_DSPC8681.xdc.inc package/rel/ti_platforms_DSPC8681/ti/platforms/DSPC8681/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/ti_platforms_DSPC8681.xdc.inc,package/rel/ti_platforms_DSPC8681.zip.dep)


release release,ti_platforms_DSPC8681: all ti_platforms_DSPC8681.zip
clean:: .clean
	-$(RM) ti_platforms_DSPC8681.zip
	-$(RM) package/rel/ti_platforms_DSPC8681.xdc.inc
	-$(RM) package/rel/ti_platforms_DSPC8681.zip.dep
